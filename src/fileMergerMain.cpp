...
main(int argc, char *argv[])
{
    ...
    general.add_options()("help,h", "Produces this help message")(
        ...
        "File ending to be used")("rename,r", po::value<bool>(&rename)->default_value(false)->zero_tokens(),
                                  "Renames sequences in case of conflict")(
    ...
    po::options_description visibleOpts("fileMerger " + project_version
                                        + " (C) 2025  Carsten Kemena\nThis program comes with ABSOLUTELY NO "
    ...
    try
    {
        auto strategy = rename ? BioSeqDataLib::SequenceSet::ConflictResolutionStrategy::Rename
                               : BioSeqDataLib::SequenceSet::ConflictResolutionStrategy::ThrowException;
